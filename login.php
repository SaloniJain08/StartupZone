...
if(isset($_POST) & !empty($_POST))
{
	...
	$sql = "SELECT * FROM `startup_signup` WHERE comp_name = '$comp_name' AND password = '$password'";
...
<div class="col-md-4">
<div class="form_main">
            <h4 class="heading"><strong>Startup Login </strong> Form <span></span></h4>
            <div class="form">
            <form action="login_profile.php" method="post" id="contactFrm">
                <input type="text" required="" placeholder="Please input your Company Name" name="comp_name" class="txt">
                <input type="password" required="" placeholder="Please enter common password" name="password" class="txt">
